...
namespace distanceMatrix
{
    public static class Matrix
    {
        ...
        public static List<distanceEntry> EXPORTnxn(List<string> points2lookup)
        {
            ...
            foreach(string str1 in points2lookup){
                foreach(string str2 in points2lookup){    
                 ...
                 if (googleDistance) {
                     tempdist.distance = googledist(Convert.ToDouble(str1list[1].Replace(".",",")), Convert.ToDouble(str1list[2].Replace(".",",")), Convert.ToDouble(str2list[1].Replace(".",",")), Convert.ToDouble(str2list[2].Replace(".",",")), "distance"); } 
                 else { 
                     tempdist.distance = dist(Convert.ToDouble(str1list[1].Replace(".",",")), Convert.ToDouble(str1list[2].Replace(".",",")), Convert.ToDouble(str2list[1].Replace(".",",")), Convert.ToDouble(str2list[2].Replace(".",","))); 
